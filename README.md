...
This extension is composed of a Python package named `jupyai`
for the server extension and a NPM package named `jupyai`
...
jupyter server extension enable jupyai
...
jupyter server extension disable jupyai
pip uninstall jupyai
```

In development mode, you will also need to remove the symlink created by `jupyter labextension develop`
command. To find its location, you can run `jupyter labextension list` to figure out where the `labextensions`
folder is located. Then you can remove the symlink named `jupyai` within that folder.
